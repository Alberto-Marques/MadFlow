...
locations = sparkSession.read.parquet("/user/alberto/madflow/traffic/locations")
...
last_locations = sparkSession.read.parquet("/user/alberto/madflow/traffic/locations/year="+_year+"/month="+_month) \
